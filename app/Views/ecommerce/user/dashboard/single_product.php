                                ...
                                <div class="col-lg-10 order-lg-2">
                                    <div class="single-product-thumbnail-wrap zoom-gallery">
                                        <div class="single-product-thumbnail product-large-thumbnail-3 axil-product">
                                            <div class="thumbnail">
                                                <a href="<?= base_url('public/user/images/product/product-big-01.png')?>" class="popup-zoom">
                                                    <img src="<?= base_url('public/user/images/product/product-big-01.png')?>" alt="Product Images">
                                                </a>
                                            </div>
                                            <div class="thumbnail">
                                                <a href="<?= base_url('public/user/images/product/product-big-02.png')?>" class="popup-zoom">
                                                    <img src="<?= base_url('public/user/images/product/product-big-02.png')?>" alt="Product Images">
                                                </a>
                                            </div>
                                            <div class="thumbnail">
                                                <a href="<?= base_url('public/user/images/product/product-big-03.png')?>" class="popup-zoom">
                                    ...
                                    <div class="col-lg-12">
                                        <ul class="pro-des-features">
                                            <li class="single-features">
                                                <div class="icon">
                                                    <img src="<?= base_url('public/user/images/product/product-thumb/icon-3.png')?>" alt="icon">
                                                </div>
                                                Easy Returns
                                            </li>
                                            <li class="single-features">
                                                <div class="icon">
                                                    <img src="<?= base_url('public/user/images/product/product-thumb/icon-2.png')?>" alt="icon">
                                                </div>
                                                Quality Service
                                            </li>
                                            <li class="single-features">
                                                <div class="icon">
                                                    <img src="<?= base_url('public/user/images/product/product-thumb/icon-1.png')?>" alt="icon">
                                                </div>
                                                Original Product
                                            </li>
                                        </ul>
                                            ...
                                            <ul class="comment-list">
                                                    ...
                                                    <div class="comment-body">
                                                        <div class="single-comment">
                                                            <div class="comment-img">
                                                                <img src="<?= base_url('public/user/images/blog/author-image-4.png')?>" alt="Author Images">
                                                            </div>
                                                ...
                                                <li class="comment">
                                                    <div class="comment-body">
                                                        <div class="single-comment">
                                                            <div class="comment-img">
                                                                <img src="<?= base_url('public/user/images/blog/author-image-5.png')?>" alt="Author Images">
                                                            </div>
                                                            <div class="comment-inner">
                                                                <h6 class="commenter">
                                                                    <a class="hover-flip-item-wrapper" href="#">
        ...
        <div class="axil-product-area bg-color-white axil-section-gap pb--50 pb_sm--30">
            <div class="container">
                <div class="section-title-wrapper">
                    <span class="title-highlighter highlighter-primary"><i class="far fa-shopping-basket"></i> Like This</span>
                    <h2 class="title">More Items</h2>
                </div>
