                ...
                <div class="row align-items-center">
                    <div class="col-xl-4 col-lg-6">
                        <div class="about-thumbnail">
                            <div class="thumbnail">
                                <img src="<?= base_url('public/user/images/about/about-01.png') ?>" alt="About Us">
                            </div>
                        </div>
                    </div>
                ...
                <div class="row row--20">
                    <div class="col-lg-4">
                        <div class="about-info-box">
                            <div class="thumb">
                                <img src="<?= base_url('public/user/images/about/shape-01.png') ?>" alt="Shape">
                            </div>
                            <div class="content">
                    ...
                    <div class="col-lg-4">
                        <div class="about-info-box">
                            <div class="thumb">
                                <img src="<?= base_url('public/user/images/about/shape-02.png') ?>" alt="Shape">
                            </div>
                            <div class="content">
                    ...
                    <div class="col-lg-4">
                        <div class="about-info-box">
                            <div class="thumb">
                                <img src="<?= base_url('public/user/images/about/shape-03.png') ?>" alt="Shape">
                            </div>
                            <div class="content">
                    ...
                    <div class="team-slide-activation slick-layout-wrapper--20 axil-slick-arrow  arrow-top-slide">
                        <div class="slick-single-layout">
                            <div class="axil-team-member">
                                <div class="thumbnail"><img src="<?= base_url('public/user/images/team/team-01.png') ?>" alt="Cody Fisher"></div>
                        ...
                        <div class="slick-single-layout">
                            <div class="axil-team-member">
                                <div class="thumbnail"><img src="<?= base_url('public/user/images/team/team-02.png') ?>" alt="Cody Fisher"></div>
                                <div class="team-content">
                        ...
                        <div class="slick-single-layout">
                            <div class="axil-team-member">
                                <div class="thumbnail"><img src="<?= base_url('public/user/images/team/team-03.png') ?>" alt="Cody Fisher"></div>
                                <div class="team-content">
                        ...
                        <div class="slick-single-layout">
                            <div class="axil-team-member">
                                <div class="thumbnail"><img src="<?= base_url('public/user/images/team/team-04.png') ?>" alt="Cody Fisher"></div>
                                <div class="team-content">
                                    <span class="subtitle">Designer</span>
                                    <h5 class="title">Alonso M. Miklonax</h5>
                                </div>
        ...
        <div class="axil-about-area about-style-2">
            <div class="container">
                <div class="row align-items-center mb--80 mb_sm--60">
                    <div class="col-lg-5">
                        <div class="about-thumbnail">
                            <img src="<?= base_url('public/user/images/about/about-02.png') ?>" alt="about">
                        </div>
                    </div>
                    <div class="col-lg-7">
                        <div class="about-content content-right">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-5 order-lg-2">
                        <div class="about-thumbnail">
                            <img src="<?= base_url('public/user/images/about/about-03.png') ?>" alt="about">
                        </div>
                    </div>
...
<!-- Mirrored from new.axilthemes.com/demo/template/etrade/about-us.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 15 Sep 2025 10:47:55 GMT -->
</html>