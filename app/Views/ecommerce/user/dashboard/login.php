            ...
            <div class="row align-items-center">
                ...
                <div class="col-sm-8">
                    <div class="singin-header-btn">
                        <p>Not a member?</p>
                        <a href="<?= base_url('user/register')?>" class="axil-btn btn-bg-secondary sign-up-btn">Sign Up Now</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="axil-signin-form">
                        ...
                        <form class="singin-form">
                            ...
                            <div class="form-group d-flex align-items-center justify-content-between">
                                ...
                                <a href="<?= base_url('user/forgot-password')?>" class="forgot-btn">Forget password?</a>
                            </div>
                        </form>
                    </div>
                </div>
