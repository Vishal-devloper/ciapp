    ...
    <main class="main-wrapper">
        <div class="axil-main-slider-area main-slider-style-1">
                                ...
                                <div class="single-slide slick-slide" data-sal="slide-up" data-sal-delay="400" data-sal-duration="800">
                                    ...
                                    <div class="slide-action">
                                        ...
                                        <div class="item-rating">
                                            <div class="thumb">
                                                <ul>
                                                    <li><img src="<?= base_url('public/user/images/others/author1.png')?>" alt="Author"></li>
                                                    <li><img src="<?= base_url('public/user/images/others/author2.png')?>" alt="Author"></li>
                                                    <li><img src="<?= base_url('public/user/images/others/author3.png')?>" alt="Author"></li>
                                                    <li><img src="<?= base_url('public/user/images/others/author4.png')?>" alt="Author"></li>
                                                </ul>
                                            </div>
                                            <div class="content">
                        ...
                        <div class="main-slider-large-thumb">
                            <div class="slider-thumb-activation-one axil-slick-dots">
                                <div class="single-slide slick-slide" data-sal="slide-up" data-sal-delay="600" data-sal-duration="1500">
                                    <img src="<?= base_url('public/user/images/product/product-38.png')?>" alt="Product">
                                ...
                                <div class="single-slide slick-slide" data-sal="slide-up" data-sal-delay="600" data-sal-duration="1500">
                                    <img src="<?= base_url('public/user/images/product/product-39.png')?>" alt="Product">
                                    <div class="product-price">
                                        <span class="text">From</span>
                                        <span class="price-amount">$49.00</span>
                                    </div>
            ...
            <ul class="shape-group">
                <li class="shape-1"><img src="<?= base_url('public/user/images/others/shape-1.png')?>" alt="Shape"></li>
                <li class="shape-2"><img src="<?= base_url('public/user/images/others/shape-2.png')?>" alt="Shape"></li>
            </ul>
        </div>
                ...
                <div class="categrie-product-activation slick-layout-wrapper--15 axil-slick-arrow  arrow-top-slide">
                    <div class="slick-single-layout">
                        <div class="categrie-product" data-sal="zoom-out" data-sal-delay="200" data-sal-duration="500">
                            <a href="#">
                                <img class="img-fluid" src="<?= base_url('public/user/images/product/categories/elec-4.png')?>" alt="product categorie">
                    ...
                    <div class="slick-single-layout">
                        <div class="categrie-product" data-sal="zoom-out" data-sal-delay="300" data-sal-duration="500">
                            <a href="#">
                                <img class="img-fluid" src="<?= base_url('public/user/images/product/categories/elec-5.png')?>" alt="product categorie">
                    ...
                    <div class="slick-single-layout">
                        <div class="categrie-product" data-sal="zoom-out" data-sal-delay="400" data-sal-duration="500">
                            <a href="#">
                                <img class="img-fluid" src="<?= base_url('public/user/images/product/categories/elec-11.png')?>" alt="product categorie">
                    ...
                    <div class="slick-single-layout">
                        <div class="categrie-product" data-sal="zoom-out" data-sal-delay="500" data-sal-duration="500">
                            <a href="#">
                                <img class="img-fluid" src="<?= base_url('public/user/images/product/categories/elec-6.png')?>" alt="product categorie">
                    ...
                    <div class="slick-single-layout">
                        <div class="categrie-product" data-sal="zoom-out" data-sal-delay="600" data-sal-duration="500">
                            <a href="#">
                                <img class="img-fluid" src="<?= base_url('public/user/images/product/categories/elec-2.png')?>" alt="product categorie">
                    ...
                    <div class="slick-single-layout">
                        <div class="categrie-product" data-sal="zoom-out" data-sal-delay="700" data-sal-duration="500">
                            <a href="#">
                                <img class="img-fluid" src="<?= base_url('public/user/images/product/categories/elec-7.png')?>" alt="product categorie">
                    ...
                    <div class="slick-single-layout">
                        <div class="categrie-product" data-sal="zoom-out" data-sal-delay="800" data-sal-duration="500">
                            <a href="#">
                                <img class="img-fluid" src="<?= base_url('public/user/images/product/categories/elec-8.png')?>" alt="product categorie">
                    ...
                    <div class="slick-single-layout">
                        <div class="categrie-product">
                            <a href="#">
                                <img class="img-fluid" src="<?= base_url('public/user/images/product/categories/elec-1.png')?>" alt="product categorie">
                    ...
                    <div class="slick-single-layout">
                        <div class="categrie-product">
                            <a href="#">
                                <img class="img-fluid" src="<?= base_url('public/user/images/product/categories/elec-9.png')?>" alt="product categorie">
                    ...
                    <div class="slick-single-layout">
                        <div class="categrie-product">
                            <a href="#">
                                <img class="img-fluid" src="<?= base_url('public/user/images/product/categories/elec-10.png')?>" alt="product categorie">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-7 col-lg-6">
                            <div class="poster-countdown-thumbnail">
                                <img src="<?= base_url('public/user/images/product/poster/poster-03.png')?>" alt="Poster Product">
                        ...
                        <div class="row row--15">
                                ...
                                <div class="axil-product product-style-one">
                                    <div class="thumbnail">
                                        <a href="single-product.html">
                                            <img data-sal="zoom-out" data-sal-delay="200" data-sal-duration="800" loading="lazy" class="main-img" src="<?= base_url('public/user/images/product/electric/product-01.png')?>" alt="Product Images">
                                            <img class="hover-img" src="<?= base_url('public/user/images/product/electric/product-08.png')?>" alt="Product Images">
                                        </a>
                            ...
                            <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                                <div class="axil-product product-style-one">
                                    <div class="thumbnail">
                                        <a href="single-product.html">
                                            <img data-sal="zoom-out" data-sal-delay="300" data-sal-duration="800" loading="lazy" src="<?= base_url('public/user/images/product/electric/product-02.png')?>" alt="Product Images">
                                            <img class="hover-img" src="<?= base_url('public/user/images/product/electric/product-06.png')?>" alt="Product Images">
                                        </a>
                                        <div class="product-hover-action">
                                            <ul class="cart-action">
                                                <li class="quickview"><a href="#" data-bs-toggle="modal" data-bs-target="#quick-view-modal"><i class="far fa-eye"></i></a></li>
                            ...
                            <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                                <div class="axil-product product-style-one">
                                    <div class="thumbnail">
                                        <a href="single-product.html">
                                            <img data-sal="zoom-out" data-sal-delay="400" data-sal-duration="800" loading="lazy" src="<?= base_url('public/user/images/product/electric/product-03.png')?>" alt="Product Images">
                                        </a>
                                        <div class="label-block label-right">
                                            <div class="product-badget">20% Off</div>
                                        </div>
                            ...
                            <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                                <div class="axil-product product-style-one">
                                    <div class="thumbnail">
                                        <a href="single-product.html">
                                            <img data-sal="zoom-out" data-sal-delay="500" data-sal-duration="800" loading="lazy" src="<?= base_url('public/user/images/product/electric/product-04.png')?>" alt="Product Images">
                                            <img class="hover-img" src="<?= base_url('public/user/images/product/electric/product-05.png')?>" alt="Product Images">
                                        </a>
                                        <div class="product-hover-action">
                                            <ul class="cart-action">
                                                <li class="quickview"><a href="#" data-bs-toggle="modal" data-bs-target="#quick-view-modal"><i class="far fa-eye"></i></a></li>
                            ...
                            <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                                <div class="axil-product product-style-one">
                                    <div class="thumbnail">
                                        <a href="single-product.html">
                                            <img data-sal="zoom-out" data-sal-delay="200" data-sal-duration="800" loading="lazy" src="<?= base_url('public/user/images/product/electric/product-05.png')?>" alt="Product Images">
                                            <img class="hover-img" src="<?= base_url('public/user/images/product/electric/product-04.png')?>" alt="Product Images">
                                        </a>
                                        <div class="label-block label-right">
                                            <div class="product-badget">20% Off</div>
                                        </div>
                            ...
                            <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                                <div class="axil-product product-style-one">
                                    <div class="thumbnail">
                                        <a href="single-product.html">
                                            <img data-sal="zoom-out" data-sal-delay="300" data-sal-duration="800" loading="lazy" src="<?= base_url('public/user/images/product/electric/product-06.png')?>" alt="Product Images">
                                        </a>
                                        <div class="label-block label-right">
                                            <div class="product-badget">20% Off</div>
                                        </div>
                            ...
                            <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                                <div class="axil-product product-style-one">
                                    <div class="thumbnail">
                                        <a href="single-product.html">
                                            <img data-sal="zoom-out" data-sal-delay="400" data-sal-duration="800" loading="lazy" src="<?= base_url('public/user/images/product/electric/product-07.png')?>" alt="Product Images">
                                            <img class="hover-img" src="<?= base_url('public/user/images/product/electric/product-08.png')?>" alt="Product Images">
                                        </a>
                                        <div class="label-block label-right">
                                            <div class="product-badget">20% Off</div>
                            ...
                            <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                                <div class="axil-product product-style-one">
                                    <div class="thumbnail">
                                        <a href="single-product.html">
                                            <img data-sal="zoom-out" data-sal-delay="500" data-sal-duration="800" loading="lazy" src="<?= base_url('public/user/images/product/electric/product-08.png')?>" alt="Product Images">
                                        </a>
                                        <div class="label-block label-right">
                                            <div class="product-badget">20% Off</div>
                                        </div>
                        ...
                        <div class="row row--15">
                            <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                                <div class="axil-product product-style-one">
                                    <div class="thumbnail">
                                        <a href="single-product.html">
                                            <img src="<?= base_url('public/user/images/product/electric/product-01.png')?>" alt="Product Images">
                                        </a>
                                        <div class="label-block label-right">
                                            <div class="product-badget">20% Off</div>
                                        </div>
                            ...
                            <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                                <div class="axil-product product-style-one">
                                    <div class="thumbnail">
                                        <a href="single-product.html">
                                            <img src="<?= base_url('public/user/images/product/electric/product-02.png')?>" alt="Product Images">
                                        </a>
                                        <div class="product-hover-action">
                                            <ul class="cart-action">
                                                <li class="quickview"><a href="#" data-bs-toggle="modal" data-bs-target="#quick-view-modal"><i class="far fa-eye"></i></a></li>
                            ...
                            <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                                <div class="axil-product product-style-one">
                                    <div class="thumbnail">
                                        <a href="single-product.html">
                                            <img src="<?= base_url('public/user/images/product/electric/product-03.png')?>" alt="Product Images">
                                        </a>
                                        <div class="label-block label-right">
                                            <div class="product-badget">20% Off</div>
                                        </div>
                            ...
                            <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                                <div class="axil-product product-style-one">
                                    <div class="thumbnail">
                                        <a href="single-product.html">
                                            <img src="<?= base_url('public/user/images/product/electric/product-04.png')?>" alt="Product Images">
                                        </a>
                                        <div class="product-hover-action">
                                            <ul class="cart-action">
                                                <li class="quickview"><a href="#" data-bs-toggle="modal" data-bs-target="#quick-view-modal"><i class="far fa-eye"></i></a></li>
                            ...
                            <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                                <div class="axil-product product-style-one">
                                    <div class="thumbnail">
                                        <a href="single-product.html">
                                            <img src="<?= base_url('public/user/images/product/electric/product-05.png')?>" alt="Product Images">
                                        </a>
                                        <div class="label-block label-right">
                                            <div class="product-badget">20% Off</div>
                                        </div>
                            ...
                            <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                                <div class="axil-product product-style-one">
                                    <div class="thumbnail">
                                        <a href="single-product.html">
                                            <img src="<?= base_url('public/user/images/product/electric/product-06.png')?>" alt="Product Images">
                                        </a>
                                        <div class="label-block label-right">
                                            <div class="product-badget">20% Off</div>
                                        </div>
                            ...
                            <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                                <div class="axil-product product-style-one">
                                    <div class="thumbnail">
                                        <a href="single-product.html">
                                            <img src="<?= base_url('public/user/images/product/electric/product-07.png')?>" alt="Product Images">
                                        </a>
                                        <div class="label-block label-right">
                                            <div class="product-badget">20% Off</div>
                                        </div>
                            ...
                            <div class="col-xl-3 col-lg-4 col-sm-6 col-12 mb--30">
                                <div class="axil-product product-style-one">
                                    <div class="thumbnail">
                                        <a href="single-product.html">
                                            <img src="<?= base_url('public/user/images/product/electric/product-08.png')?>" alt="Product Images">
                                        </a>
                                        <div class="label-block label-right">
                                            <div class="product-badget">20% Off</div>
                                        </div>
            ...
            <div class="container">
                ...
                <div class="testimonial-slick-activation testimonial-style-one-wrapper slick-layout-wrapper--20 axil-slick-arrow arrow-top-slide">
                    <div class="slick-single-layout testimonial-style-one">
                        ...
                        <div class="media">
                            <div class="thumbnail">
                                <img src="<?= base_url('public/user/images/testimonial/image-1.png')?>" alt="testimonial image">
                            </div>
                    ...
                    <div class="slick-single-layout testimonial-style-one">
                        ...
                        <div class="media">
                            <div class="thumbnail">
                                <img src="<?= base_url('public/user/images/testimonial/image-2.png')?>" alt="testimonial image">
                            </div>
                            <div class="media-body">
                                <span class="designation">Head Of Idea</span>
                                <h6 class="title">James C. Anderson</h6>
                    ...
                    <div class="slick-single-layout testimonial-style-one">
                        ...
                        <div class="media">
                            <div class="thumbnail">
                                <img src="<?= base_url('public/user/images/testimonial/image-3.png')?>" alt="testimonial image">
                            </div>
                            <div class="media-body">
                                <span class="designation">Head Of Idea</span>
                                <h6 class="title">James C. Anderson</h6>
                    ...
                    <div class="new-arrivals-product-activation slick-layout-wrapper--30 axil-slick-arrow  arrow-top-slide">
                        <div class="slick-single-layout">
                            <div class="axil-product product-style-two">
                                <div class="thumbnail">
                                    <a href="single-product.html">
                                        <img data-sal="zoom-out" data-sal-delay="200" data-sal-duration="500" src="<?= base_url('public/user/images/product/electric/product-05.png') ?>" alt="Product Images">
                                    </a>
                                    <div class="label-block label-right">
                        ...
                        <div class="slick-single-layout">
                            <div class="axil-product product-style-two">
                                <div class="thumbnail">
                                    <a href="single-product.html">
                                        <img data-sal="zoom-out" data-sal-delay="300" data-sal-duration="500" src="<?= base_url('public/user/images/product/electric/product-06.png')?>" alt="Product Images">
                                    </a>
                                </div>
                                <div class="product-content">
                                    <div class="inner">
                        ...
                        <div class="slick-single-layout">
                            <div class="axil-product product-style-two">
                                <div class="thumbnail">
                                    <a href="single-product.html">
                                        <img data-sal="zoom-out" data-sal-delay="400" data-sal-duration="500" src="<?= base_url('public/user/images/product/electric/product-07.png')?>" alt="Product Images">
                                    </a>
                                    <div class="label-block label-right">
                        ...
                        <div class="slick-single-layout">
                            <div class="axil-product product-style-two">
                                <div class="thumbnail">
                                    <a href="single-product.html">
                                        <img data-sal="zoom-out" data-sal-delay="500" data-sal-duration="500" src="<?= base_url('public/user/images/product/electric/product-08.png')?>" alt="Product Images">
                                    </a>
                                    <div class="label-block label-right">
                        ...
                        <div class="slick-single-layout">
                            <div class="axil-product product-style-two">
                                <div class="thumbnail">
                                    <a href="single-product.html">
                                        <img data-sal="zoom-out" data-sal-delay="100" data-sal-duration="500" src="<?= base_url('public/user/images/product/electric/product-04.png')?>" alt="Product Images">
                                    </a>
                                    <div class="label-block label-right">
                    ...
                    <div class="row row-cols-xl-2 row-cols-1 row--15">
                        <div class="col">
                            <div class="axil-product-list">
                                <div class="thumbnail">
                                    <a href="single-product.html">
                                        <img data-sal="zoom-in" data-sal-delay="100" data-sal-duration="1500" src="<?= base_url('public/user/images/product/electric/product-09.png')?>" alt="Yantiti Leather Bags">
                                    </a>
                                </div>
                                <div class="product-content">
                                    <div class="product-rating">
                        ...
                        <div class="col">
                            <div class="axil-product-list">
                                <div class="thumbnail">
                                    <a href="single-product.html">
                                        <img data-sal="zoom-in" data-sal-delay="200" data-sal-duration="1500" src="<?= base_url('public/user/images/product/electric/product-10.png')?>" alt="Yantiti Leather Bags">
                                    </a>
                                </div>
                                <div class="product-content">
                                    <div class="product-rating">
                        ...
                        <div class="col">
                            <div class="axil-product-list">
                                <div class="thumbnail">
                                    <a href="single-product.html">
                                        <img data-sal="zoom-in" data-sal-delay="300" data-sal-duration="1500" src="<?= base_url('public/user/images/product/electric/product-11.png')?>" alt="Yantiti Leather Bags">
                                    </a>
                                </div>
                                <div class="product-content">
                                    <div class="product-rating">
                        ...
                        <div class="col">
                            <div class="axil-product-list">
                                <div class="thumbnail">
                                    <a href="single-product.html">
                                        <img data-sal="zoom-in" data-sal-delay="400" data-sal-duration="1500" src="<?= base_url('public/user/images/product/electric/product-12.png')?>" alt="Yantiti Leather Bags">
                                    </a>
                                </div>
                                <div class="product-content">
                                    <div class="product-rating">
                        ...
                        <div class="col">
                            <div class="axil-product-list">
                                <div class="thumbnail">
                                    <a href="single-product.html">
                                        <img data-sal="zoom-in" data-sal-delay="500" data-sal-duration="1500" src="<?= base_url('public/user/images/product/electric/product-13.png')?>" alt="Yantiti Leather Bags">
                                    </a>
                                </div>
                                <div class="product-content">
                                    <div class="product-rating">
                        ...
                        <div class="col">
                            <div class="axil-product-list">
                                <div class="thumbnail">
                                    <a href="single-product.html">
                                        <img data-sal="zoom-in" data-sal-delay="600" data-sal-duration="1500" src="<?= base_url('public/user/images/product/electric/product-14.png')?>" alt="Yantiti Leather Bags">
                                    </a>
                                </div>
                                <div class="product-content">
                                    <div class="product-rating">
                        ...
                        <div class="col">
                            <div class="axil-product-list">
                                <div class="thumbnail">
                                    <a href="single-product.html">
                                        <img data-sal="zoom-in" data-sal-delay="400" data-sal-duration="1500" src="<?= base_url('public/user/images/product/electric/product-15.png')?>" alt="Yantiti Leather Bags">
                                    </a>
                                </div>
                                <div class="product-content">
                                    <div class="product-rating">
                        ...
                        <div class="col">
                            <div class="axil-product-list">
                                <div class="thumbnail">
                                    <a href="single-product.html">
                                        <img data-sal="zoom-in" data-sal-delay="500" data-sal-duration="1500" src="<?= base_url('public/user/images/product/electric/product-16.png')?>" alt="Yantiti Leather Bags">
                                    </a>
                                </div>
                                <div class="product-content">
                                    <div class="product-rating">
                ...
                <div class="row row-cols-xl-5 row-cols-lg-4 row-cols-md-3 row-cols-sm-2 row-cols-1 row--20">
                    <div class="col">
                        <div class="service-box">
                            <div class="icon">
                                <img src="<?= base_url('public/user/images/icons/service6.png')?>" alt="Service">
                            </div>
                    ...
                    <div class="col">
                        <div class="service-box">
                            <div class="icon">
                                <img src="<?= base_url('public/user/images/icons/service7.png')?>" alt="Service">
                            </div>
                    ...
                    <div class="col">
                        <div class="service-box">
                            <div class="icon">
                                <img src="<?= base_url('public/user/images/icons/service8.png')?>" alt="Service">
                            </div>
                    ...
                    <div class="col">
                        <div class="service-box">
                            <div class="icon">
                                <img src="<?= base_url('public/user/images/icons/service9.png')?>" alt="Service">
                            </div>
                            <h6 class="title">24 Hour Return Policy</h6>
                        </div>
                    </div>
                    <div class="col">
                        <div class="service-box">
                            <div class="icon">
                                <img src="<?= base_url('public/user/images/icons/service10.png')?>" alt="Service">
                            </div>
                ...
                <div class="row">
                    <div class="col-lg-6 mb--30">
                        <div class="single-poster">
                            <a href="shop.html">
                                <img src="<?= base_url('public/user/images/product/poster/poster-01.png')?>" alt="eTrade promotion poster">
                    ...
                    <div class="col-lg-6 mb--30">
                        <div class="single-poster">
                            <a href="shop-sidebar.html">
                                <img src="<?= base_url('public/user/images/product/poster/poster-02.png')?>" alt="eTrade promotion poster">
