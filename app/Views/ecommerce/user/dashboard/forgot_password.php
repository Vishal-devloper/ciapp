        ...
        <div class="signin-header">
            <div class="row align-items-center">
                <div class="col-xl-4 col-sm-6">
                    <a href="<?= base_url('user/login')?>" class="site-logo"><img src="<?= base_url('public/user/images/logo/logo.png')?>" alt="logo"></a>
                </div>
                <div class="col-md-2 d-lg-block d-none">
                    <a href="<?= base_url('user/login')?>" class="back-btn"><i class="far fa-angle-left"></i></a>
                </div>
                <div class="col-xl-6 col-lg-4 col-sm-6">
                    <div class="singin-header-btn">
                        <p>Already a member?</p>
                        <a href="<?= base_url('user/login')?>" class="sign-up-btn axil-btn btn-bg-secondary">Sign In</a>
                    </div>
                </div>
            </div>
        </div>
