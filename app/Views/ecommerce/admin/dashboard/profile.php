            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-xlg-3 col-md-12">
                        <div class="white-box">
                            <div class="user-bg"> <img width="100%" alt="user" src="<?= base_url('public/admin/plugins/images/large/img1.jpg') ?>">
                                <div class="overlay-box">
                                    <div class="user-content">
                                        <a href="javascript:void(0)"><img src="<?= base_url('public/admin/plugins/images/users/genu.jpg') ?>"
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" placeholder="Johnathan Doe" name="name"
                                                class="form-control p-0 border-0" value="<?= esc($user['name']) ?>" required> </div>
                                    </div>
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="email" placeholder="johnathan@admin.com"
                                                ...
                                                id="example-email" value="<?= esc($user['email']) ?>" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group mb-4">
