...
<body>
  <div class="wrapper">
    <form id="forgotPassword" action="<?php echo site_url('admin/User/forgotPassword') ?>" method="post">
      <?= csrf_field() ?>
  ...
  <script>
    const ajaxRequestUrlForgotPassword ="<?= site_url('admin/User/forgotPassword') ?>";
